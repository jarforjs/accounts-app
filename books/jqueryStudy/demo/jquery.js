...
define(function (require, exports, module) {
    ...
    select.prototype = {
        init: function init() {
            ...
            for (var value in this.seValue2) {
                if (Object.prototype.hasOwnProperty.call(this.seValue2, value)) {
                    if (this.seValue2.length == 1 && this.seValue2 == '') return;
        ...
        addClass: function addClass(obj, name) {
            var classArr = obj.className.split(' ');
            for (var i = 0; i < classArr.length; i++) {
                if (classArr[i] == name) return;
            }
            if (obj.className) obj.className += ' ' + name;else obj.className = name;
        },
        removeClass: function removeClass(obj, name) {
            var classArr = obj.className.split(' ');
            for (var i = classArr.length - 1; i >= 0; i--) {
                if (classArr[i] == name) classArr.splice(i, 1);
            }
